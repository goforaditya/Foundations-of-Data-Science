...
def naive_bayes_classifier_on_file(filename):
    '''
    ================================================
    ...
    n=len(df)
    splitat = np.random.rand(len(df)) < 0.90
...
if __name__=='__main__':
    ...
    try:
        if len(sys.argv>1):
            ...
            name_of_file = 'car.data.txt' # or input your own file name
    except (ValueError, TypeError):
        print('Check Your File Location and/or Name')
    
    naive_bayes_classifier_on_file(name_of_file,split_ratio)
